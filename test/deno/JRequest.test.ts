...
import { JCommand, CommandType, JQuery, JRequest, JSecurity, SecurityMode } from "../../mod.ts";
import { assertError, tryCatch } from "./Tools.ts"

// 测试 Security 对象的封装
Deno.test({
    name: 'JSecurity Constructor',
    fn(): void {
